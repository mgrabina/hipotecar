                ...
                {keys.map((key, index) => (
                  <TableCell
                    ...
                    style={{
                      ...
                      position:
                        (index === 0 || key === 'Logo Banco' || key === 'Tipo') && !isSmallScreen ? 'sticky' : 'static',
                      left:
                        key === 'Logo Banco' && !isSmallScreen ? 0 : key === 'Tipo' && !isSmallScreen ? 262.5 : 'auto',
                      width: '200px',
                      zIndex: (key === 'Logo Banco' || key === 'Tipo') && !isSmallScreen ? 1 : 0
                    }}
                  >
                    <TableSortLabel
                ...
                <TableRow key={index} hover>
                  {keys.map(key => (
                    <TableCell
                      ...
                      style={{
                        position:
                          (index === 0 || key === 'Logo Banco' || key === 'Tipo') && !isSmallScreen
                            ? 'sticky'
                            : 'static',
                        left:
                          key === 'Logo Banco' && !isSmallScreen
                            ? 0
                            : key === 'Tipo' && !isSmallScreen
                            ? 262.5
                            : 'auto',
                        zIndex: (key === 'Logo Banco' || key === 'Tipo') && !isSmallScreen ? 1 : 0,
